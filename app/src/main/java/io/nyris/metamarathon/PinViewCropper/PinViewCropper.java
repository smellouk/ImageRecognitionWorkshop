/*
 * PinViewCropper.java
 * Created or changed by nyris GmbH
 * Copyright © 2018 nyris GmbH. All rights reserved.
*/

package io.nyris.metamarathon.PinViewCropper;
...
import io.nyris.metamarathon.PinViewCropper.cropwindow.edge.Edge;
import io.nyris.metamarathon.PinViewCropper.cropwindow.handle.Handle;
import io.nyris.metamarathon.PinViewCropper.util.AspectRatioUtil;
import io.nyris.metamarathon.PinViewCropper.util.HandleUtil;
import io.nyris.metamarathon.PinViewCropper.util.PaintUtil;
import io.nyris.metamarathon.R;
...
public class PinViewCropper extends FrameLayout {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        OnPinClickListener onPinClickListener = objectProposal -> selectedObjectProposal = objectProposal;
